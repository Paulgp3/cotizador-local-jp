...
function createQuotePDF({ quoteId, client, calc }){
  return new Promise((resolve, reject) => {
    ...
    const obsTxt = [
      "Esta cotización es una estimación automática de carácter informativo y no representa una propuesta final confirmada.",
      "La propuesta final deberá ser validada por un especialista de Medio Angular, considerando las necesidades reales del proyecto, el equipo adecuado para cubrir correctamente el espacio, la logística de montaje y desmontaje, fechas, horarios, accesos, tiempos de carga, montajes especiales y condiciones reales del recinto.",
...
async function sendQuoteEmail({ toEmail, clientName, eventLabel, quoteId, pdfPath }){
  ...
  blocks.push(
    ...
    `<p style="margin:0 0 8px">Como lo solicitaste, adjuntamos una estimación automática inicial para tu evento: ${eventLabel || "—"}.</p>`,
    `<p style="margin:0 0 8px">Esta cotización es informativa y servirá como punto de partida para revisar tus necesidades. Un especialista de Medio Angular validará los detalles técnicos, operativos y logísticos antes de confirmar la propuesta final.</p>`,
    `<p style="margin:0 0 8px">En esta revisión podremos:</p>`,
    `<ul style="margin:0 0 8px 18px;padding:0">
       <li>Confirmar el equipo adecuado para cubrir correctamente el espacio.</li>
       <li>Revisar ubicación, accesos, horarios, montaje y desmontaje.</li>
       <li>Validar personal técnico, transportes, fletes, viáticos, hospedajes u otros costos operativos que puedan aplicar.</li>
       <li>Ajustar la propuesta final a las condiciones reales de tu evento.</li>
     </ul>`,
    SG_CALENDLY
      ? `<p style="margin:0 0 8px">Puedes agendar una llamada aquí: ${SG_CALENDLY}</p>`
